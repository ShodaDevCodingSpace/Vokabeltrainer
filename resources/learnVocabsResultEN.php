<?php
   ...
   for ($i = 0; $i < $trueVocabsCount; $i++) {
      $trueVocabsReturn[] = '<tr><td>' . $trueVocabs[$i]['german'] . '</td><td>' . $trueVocabs[$i]['english'] . '</td></tr>';
   }

   for ($i = 0; $i < $falseVocabsCount; $i++) {
      $falseVocabsReturn[] = '<tr><td>' . $falseVocabs[$i]['german'] . '</td><td>' . $falseVocabs[$i]['english'] . '</td></tr>';
   }

   $trueTable = "<table><thead><tr><th>Deutsch</th><th>Englisch</th></tr></thead><tbody>" . implode('', $trueVocabsReturn) . "</tbody></table>";
   $falseTable = "<table><thead><tr><th>Deutsch</th><th>Englisch</th></tr></thead><tbody>" . implode('', $falseVocabsReturn) . "</tbody></table>";
